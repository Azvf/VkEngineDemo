...
#define CUBEMAP_PREFILTER_PASS_SETUP_CONTEXT \
    ...
    void CubeMapPrefilterPass::SetupPipeline()
    {
        ...
        graphics_shaders.InitShader((shaders_folder / "cubemap_prefilter_gen_vert.spv").string(),
                                    GraphicsPipelineShaders::Vertex_Shader);
        graphics_shaders.InitShader((shaders_folder / "cubemap_prefilter_gen_frag.spv").string(),
