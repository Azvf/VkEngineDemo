...
#define TypeMetaDef(class_name, ptr) \
    Chandelier::Reflection::ReflectionInstance(Chandelier::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                            (class_name*)ptr)

#define TypeMetaDefPtr(class_name, ptr) \
    new Chandelier::Reflection::ReflectionInstance(Chandelier::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                                (class_name*)ptr)
