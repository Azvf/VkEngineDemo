...
if (CMAKE_HOST_WIN32)
    ...
    message(FATAL_ERROR "not supported for other plateforms for now")
endif()
...
COMMAND
    ${PRECOMPILE_PARSER} "${PICCOLO_PRECOMPILE_PARAMS_PATH}"  "${PARSER_INPUT}"  "${ENGINE_ROOT_DIR}/source" ${sys_include} "Chandelier" 0
### BUILDING ====================================================================================
COMMAND
